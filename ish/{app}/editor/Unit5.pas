...
//Dobavil Serafim Meleshko(4 stroki)
    procedure Label1Open(Sender: TObject);
...
procedure TGrafikXY.Label1Open(Sender: TObject);
begin
   Label1.Caption:='Проект: ' +Unit2GetProjectName;
end;

//Dobavil Serafim Meleshko(1 procedura)
procedure TGrafikXY.Inter(Sender: TObject);
//TSH -->
var MyNrc :integer;
  begin
     Series1.Clear;
...
//Dobavil Serafim Meleshko(1 procedura)
procedure TGrafikXY.Inter2(Sender: TObject);
//TSH -->
...
//Dobavil Serafim Meleshko(1 procedura)
procedure TGrafikXY.Inter3(Sender: TObject);
//TSH -->
