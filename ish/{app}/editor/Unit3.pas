...
var
  ...
  Grdisplay:boolean;
//Peremennaya Unit2GetProjectName peredayet imya proecta v ostalniye Unit-ы, dobavil Meleshko Serafim(1 stroka)
...
var
        Ret: Integer;
//Dobavil Serafim Meleshko(1 stroka)
        abcd: String;
Begin
...
//Dobavil Serafim Meleshko(2 stroki)
             abcd:=IntToStr(NrcMy);
             WaitForm1.StartShow2('Построение графиков сходимости...',abcd);
             Repeat
...
//Dobavil Serafim Meleshko(24 strok)
             ...
             GrafikX.series5.Clear;
             GrafikX.series6.Clear;
             GrafikY.series5.Clear;
             GrafikY.series6.Clear;
             GrafikXY.series5.Clear;
             GrafikXY.series6.Clear;
             GrafikGl.series5.Clear;
             GrafikGl.series6.Clear;
             GrafikGl2.series5.Clear;
             GrafikGl2.series6.Clear;
             GrafikUG.series5.Clear;
             GrafikUG.series6.Clear;
...
//Dobavil Meleshko Serafim(1 stroka)
Form11.ClientHeight:=450;
Form11.ClientWidth:=300;
