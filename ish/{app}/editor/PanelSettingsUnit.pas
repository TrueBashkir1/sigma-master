...
procedure TPanelSettings.btnCalcArcLengthClick(Sender: TObject);
begin
  // установить флаг
  CalcArc := True;
...
procedure TPanelSettings.insertNodeIntoList(MouseX, MouseY, Scale : double);
var
  nodeNumber : integer;
begin
...
procedure TPanelSettings.calculateLinear(nodeList : array of integer);
var
...
begin
  ...
  resLinear.Text := FloatToStrF(r, ffFixed, 2, 10);
...
procedure TPanelSettings.calculateArc(nodeList : array of integer);
var
...
begin
  ...
  res1a.Text := FloatToStrF(l1, ffFixed, 2, 10);
  res1a.Visible := true;
  ...
  res2a.Text := FloatToStrF(l2, ffFixed, 2, 10);
  res2a.Visible := true;
  ...
  res3a.Text := FloatToStrF(l3, ffFixed, 2, 10);
  res3a.Visible := true;
...
procedure TPanelSettings.btnCalcLinearClick(Sender: TObject);
begin
  // установить флаг
  CalcLinear := True;
...
procedure TPanelSettings.FormClose(Sender: TObject;
