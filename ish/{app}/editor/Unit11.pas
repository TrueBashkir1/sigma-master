...
//Dobavil Serafim Meleshko(1 stroka)
    procedure Label6Open(Sender: TObject);
  private
...
count:=0;
 ...
 if(count > 4) then
  begin;
    MessageDlg('Количество используемых точек должно быть не менее 1.',mtError,[mbYes],0);
    exit;
  end;
...
procedure TForm11.Label6Open(Sender: TObject);
begin
   Label6.Caption:='Проект: ' +Unit2GetProjectName;
end;
