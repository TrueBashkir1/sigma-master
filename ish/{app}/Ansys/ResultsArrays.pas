...
TYPE
  ...
  TOneElement = RECORD
    Number                              : INTEGER;
    Node1,Node2,Node3,Node4,Node5,Node6 : INTEGER;
  ...
  PUBLIC
    ...
    FUNCTION FindNodeByRenum(n:INTEGER):TOneNode;
...
FUNCTION TNodes.FindNodeByRenum(n:INTEGER):TOneNode;
VAR
 i : INTEGER;
 r : TOneNode;
BEGIN
  r.Number:=-1; //not find
  FOR i:=1 TO CountOfNodes DO
  IF ArrayOfNodes[i-1].RenumNum=n THEN r:=ArrayOfNodes[i-1];
  Result:=r;
END;
