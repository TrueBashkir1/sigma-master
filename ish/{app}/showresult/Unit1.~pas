...
// копирование выделенных(-ной) €чеек(-ки) в буфер обмена кликом мыши
...
// внесение в будущий буфер выделенных €чеек построчно
if i=myrect.Right then res:=res+StringGrid1.Cells[i,j]
else res:=res+StringGrid1.Cells[i,j]+#9; // разделитель €чеек
