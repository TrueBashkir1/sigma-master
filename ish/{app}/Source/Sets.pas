...
'23. Распределение нагрузки по узлам. (FORCE)', '24. Различные схемы хранения матриц', '25. Характеристики модифицированной профильной схемы хранения', '26.  Сообщения о работе программ', '27.  Распределение памяти для профильного метода XENV (MAIN)',
