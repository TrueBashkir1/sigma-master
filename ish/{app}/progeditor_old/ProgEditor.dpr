...
begin
     ...
     Menu:=RegisterMenu(Plugin,PChar('Фортрановские модули'),93,2,PChar('ShowForm'));
     Button:=RegisterToolButton(Plugin,PChar('Фортрановские модули'),93,'Импорт',PChar('ShowForm'));
