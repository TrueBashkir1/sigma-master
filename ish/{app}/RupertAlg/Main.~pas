...
begin
  ...
  begin
    ...
    ActiveWindow.Items.Add('Display of results');
    ActiveForm[1]:=ActiveWindow.items.IndexOf('Display of results')+1;
    ActiveWindow.ItemIndex:=ActiveWindow.items.IndexOf('Display of results');
...
begin
  ...
  begin
    ...
    AlgF.Show;
    ActiveWindow.Items.Add('Algorithms');
    ActiveForm[2]:=ActiveWindow.items.IndexOf('Algorithms')+1;
    ActiveWindow.ItemIndex:=ActiveWindow.items.IndexOf('Algorithms');
    ActiveWindowClick(Sender);
  end
  else begin
    //Если форма уже открыта, то делаем её активной.
...
begin
  ...
  begin
    ...
    SegF.ShowForm;
    ActiveWindow.Items.Add('Grid of FE');
    ActiveForm[3]:=ActiveWindow.items.IndexOf('Grid of FE')+1;
    ActiveWindow.ItemIndex:=ActiveWindow.items.IndexOf('Grid of FE');
    ActiveWindowClick(Sender);
  end
  else begin
...
begin
  ...
  begin
    ...
    SysSettingF.Show;
    ActiveWindow.Items.Add('System settings');
    ActiveForm[5]:=ActiveWindow.items.IndexOf('System settings')+1;
    ActiveWindow.ItemIndex:=ActiveWindow.items.IndexOf('System settings');
    ActiveWindowClick(Sender);
  end
  else begin
  //Если форма уже открыта, то делаем её активной.
...
begin
  if ActiveForm[1]>0 then ActiveForm[1]:=ActiveWindow.items.IndexOf('Display of results')+1;
  if ActiveForm[2]>0 then ActiveForm[2]:=ActiveWindow.items.IndexOf('Algorithms')+1;
  if ActiveForm[3]>0 then ActiveForm[3]:=ActiveWindow.items.IndexOf('Grid of FE')+1;
  if ActiveForm[4]>0 then ActiveForm[4]:=ActiveWindow.items.IndexOf('')+1;
  if ActiveForm[5]>0 then ActiveForm[5]:=ActiveWindow.items.IndexOf('System settings')+1;
end;
