...
begin
     ...
     Menu:=RegisterMenu(Plugin,'Подсистема Рапперта',113,3,PChar('ShowMainRupert'));
     Button:=RegisterToolButton(Plugin,'Подсистема Рапперта',113,PChar('Сетка'),PChar('ShowMainRupert'));
