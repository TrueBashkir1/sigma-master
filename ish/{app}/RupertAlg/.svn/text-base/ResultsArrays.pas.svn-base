...
{*****>}
    FUNCTION GetNodeCordX(N:INTEGER):MyReal;
    FUNCTION GetNodeCordY(N:INTEGER):MyReal;
    FUNCTION GetCount():Integer;
    FUNCTION GetNodeRenum(n:INTEGER):INTEGER;
    FUNCTION GetCopyNode(n:INTEGER):TOneNode;
    PROCEDURE SetCopyNode(n:INTEGER;OneNode:TOneNode);
{<*****}
 END;
...
{*****>}
FUNCTION TNodes.GetNodeCordX(N: Integer):MyReal;
  VAR OneNode : TOneNode;
  BEGIN Result:= ArrayOfNodes[n-1].x; END;

FUNCTION TNodes.GetNodeCordY(N: Integer):MyReal;
  VAR OneNode : TOneNode;
...
FUNCTION TNodes.GetNodeRenum(n:INTEGER):INTEGER;
  VAR i,r : INTEGER;
  BEGIN Result:=ArrayOfNodes[n-1].RenumNum; END;

FUNCTION TNodes.GetCopyNode(n:INTEGER):TOneNode;
  BEGIN result:=ArrayOfNodes[n-1]; END;

PROCEDURE TNodes.SetCopyNode(n: Integer; OneNode:TOneNode);
  BEGIN
