...
begin
     ...
     Menu:=RegisterMenu(Plugin,PChar('Редактор исходных файлов'),93,2,PChar('ShowForm'));
     Button:=RegisterToolButton(Plugin,PChar('Редактор исходных файлов'),93,'Импорт',PChar('ShowForm'));
